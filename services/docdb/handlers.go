...
func handleCreateDBCluster(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlCreateDBClusterResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBCluster = toXC(c)
	return xmlOK(resp)
}
...
func handleDescribeDBClusters(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDescribeDBClustersResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBClusters = xc
	return xmlOK(resp)
}
...
func handleDeleteDBCluster(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDeleteDBClusterResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBCluster = toXC(c)
	return xmlOK(resp)
}
...
func handleModifyDBCluster(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	if !ok { return xmlErr(service.NewAWSError("DBClusterNotFoundFault", "Cluster "+id+" not found.", http.StatusNotFound)) }
	resp := &xmlModifyDBClusterResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBCluster = toXC(c)
	return xmlOK(resp)
}
...
func handleCreateDBInstance(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlCreateDBInstanceResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBInstance = toXI(inst)
	return xmlOK(resp)
}
...
func handleDescribeDBInstances(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDescribeDBInstancesResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBInstances = xi
	return xmlOK(resp)
}
...
func handleDeleteDBInstance(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDeleteDBInstanceResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBInstance = toXI(inst)
	return xmlOK(resp)
}
...
func handleModifyDBInstance(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	if !ok { return xmlErr(service.NewAWSError("DBInstanceNotFound", "Instance "+id+" not found.", http.StatusNotFound)) }
	resp := &xmlModifyDBInstanceResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBInstance = toXI(inst)
	return xmlOK(resp)
}
...
func handleCreateDBClusterSnapshot(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlCreateSnapshotResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBClusterSnapshot = toXS(snap)
	return xmlOK(resp)
}
...
func handleDescribeDBClusterSnapshots(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDescribeSnapshotsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBClusterSnapshots = xs
	return xmlOK(resp)
}
...
func handleDeleteDBClusterSnapshot(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	return xmlOK(&xmlDeleteSnapshotResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}})
}
...
func handleCreateDBSubnetGroup(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlCreateSubnetGroupResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBSubnetGroup = toXSG(sg)
	return xmlOK(resp)
}
...
func handleDescribeDBSubnetGroups(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDescribeSubnetGroupsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBSubnetGroups = xg
	return xmlOK(resp)
}
...
func handleDeleteDBSubnetGroup(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	return xmlOK(&xmlDeleteSubnetGroupResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}})
}
...
func handleCreateDBClusterParameterGroup(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlCreateParamGroupResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}
...
func handleDescribeDBClusterParameterGroups(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlDescribeParamGroupsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.DBClusterParameterGroups = xg
	return xmlOK(resp)
}
...
func handleDeleteDBClusterParameterGroup(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	return xmlOK(&xmlDeleteParamGroupResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}})
}
...
func handleAddTagsToResource(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	return xmlOK(&xmlAddTagsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}})
}
...
func handleRemoveTagsFromResource(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	return xmlOK(&xmlRemoveTagsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}})
}
...
func handleListTagsForResource(ctx *service.RequestContext, store *Store) (*service.Response, error) {
	...
	resp := &xmlListTagsResp{Xmlns: docdbXmlns, Meta: xmlResponseMetadata{reqID()}}; resp.Result.TagList = xt
	return xmlOK(resp)
}
