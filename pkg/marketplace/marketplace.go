...
func seedListings() []PluginListing {
	return []PluginListing{
		// Built-in plugins (installed by default)
		{
			...
			Downloads:   1250,
			Rating:      4.8,
			RepoURL:     "https://github.com/Viridian-Inc/cloudmock/tree/main/plugins/kubernetes",
			InstallCmd:  "built-in",
			Installed:   true,
		},
		{
			...
			Downloads:   890,
			Rating:      4.7,
			RepoURL:     "https://github.com/Viridian-Inc/cloudmock/tree/main/plugins/argocd",
			InstallCmd:  "built-in",
			Installed:   true,
		},
		{
			...
			Downloads:   680,
			Rating:      4.6,
			RepoURL:     "https://github.com/Viridian-Inc/cloudmock/tree/main/plugins/flyio",
			InstallCmd:  "built-in",
			Installed:   true,
		},
		{
			...
			Downloads:   320,
			Rating:      4.2,
			RepoURL:     "https://github.com/Viridian-Inc/cloudmock/tree/main/plugins/example",
			InstallCmd:  "built-in",
			Installed:   true,
		},
