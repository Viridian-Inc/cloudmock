...
Starts all 100 fully emulated AWS services. Use this when your application depends on less common services, or when you want full coverage without listing services individually.
