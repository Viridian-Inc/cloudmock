...
# Use the full profile (all 100 services)
...
Check the [Compatibility Matrix](/docs/reference/compatibility-matrix/). CloudMock supports 100 fully emulated AWS services.
