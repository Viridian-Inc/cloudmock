...
echo "     - Root:          /"
echo "  4. Set custom domain: cloudmock.dev"
echo ""
...
echo ""
echo "  1. Add CNAME: cloudmock.dev -> your Cloudflare Pages deployment"
echo "  2. Add CNAME: *.cloudmock.dev -> cloudmock-saas.fly.dev (proxied)"
echo "  3. Verify: dig +short test.cloudmock.dev"
echo ""
read -p "  Press Enter when done (or skip)..."
echo ""
...
echo "  - https://cloudmock.dev (homepage)"
echo "  - https://cloudmock.dev/docs (documentation)"
echo "  - https://cloudmock.dev/pricing (pricing)"
echo ""
...
echo "  - Reddit r/aws, r/devops: link to cloudmock.dev"
