...
/** Warning triangle for Anomalies */
export function AnomalyIcon(p: IconProps) {
  return <Icon {...p}>
    <circle cx="12" cy="12" r="10" />
...
/** Globe/network icon for API Gateway */
...
/** Globe with lines for DNS / Route 53 */
export function DNSIcon(p: IconProps) {
  return <Icon {...p}>
    <circle cx="12" cy="12" r="10" />
...
/** Megaphone/bell icon for SNS */
export function SNSIcon(p: IconProps) {
  return <Icon {...p}>
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
  </Icon>;
...
/** Calendar/event icon for EventBridge */
export function EventBridgeIcon(p: IconProps) {
  return <Icon {...p}>
